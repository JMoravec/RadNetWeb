...
urlpatterns = patterns('',
                       ...
                       url(r'^AddRawData/Save/(?P<filter_num>\d+)(?P<number_of_rows>\d+)/$', views.save_raw_data,
                           name='saveRawData'),
                       url(r'^CheckData/$', views.check_data, name='checkData'),
                       url(r'^CheckData/(?P<filter_id>\d+)/$', views.check_data, name='checkDataFilter'),
                       )
