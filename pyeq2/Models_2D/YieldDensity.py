...
class Bleasdale(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
...
class ExtendedHolliday(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
...
class Harris(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
...
class Holliday(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
...
class InverseBleasdale(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
...
class InverseHarris(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
